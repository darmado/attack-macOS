#!/bin/sh
# POSIX-compliant
# Procedure Name: modify_firewall_settings
...
DISABLE_APPFIREWALL=false
ENABLE_APPFIREWALL=false
DISABLE_ALF=false
ENABLE_ALF=false
DISABLE_SPCTL=false
ENABLE_SPCTL=false
...
PROCEDURE_NAME="modify_firewall_settings"  # Set by build system from YAML procedure_name field
...
# We need to  accomidate the unknown rgs condiuton for the new args we add from the yaml
        ...
        --enable-gatekeeper)
            ...
            ;;
        --disable-appfirewall)
            DISABLE_APPFIREWALL=true
            ;;
        --enable-appfirewall)
            ENABLE_APPFIREWALL=true
            ;;
        --disable-alf)
            DISABLE_ALF=true
            ;;
...
Script Options:
  --disable-gatekeeper      Write GKAutoRearm -bool NO to /Library/Preferences/com.apple.security using defaults
  --enable-gatekeeper       Write GKAutoRearm -bool YES to /Library/Preferences/com.apple.security using defaults
  --disable-appfirewall     Execute socketfilterfw --setglobalstate off
  --enable-appfirewall      Execute socketfilterfw --setglobalstate on
  --disable-alf             Write globalstate -int 0 to /Library/Preferences/com.apple.alf using defaults
  --enable-alf              Write globalstate -int 1 to /Library/Preferences/com.apple.alf using defaults
  --disable-spctl           Execute spctl --master-disable
  --enable-spctl            Execute spctl --master-enable
  --check-status            Read current values from all security preference files and spctl status
  --restore-defaults        Write all security settings back to enabled state
...
if [ "$DISABLE_GATEKEEPER" = true ]; then
    ...
    result=$(execute_function disable_gatekeeper_defaults)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --enable-gatekeeper
if [ "$ENABLE_GATEKEEPER" = true ]; then
    core_debug_print "Executing functions for --enable-gatekeeper"
    result=$(execute_function enable_gatekeeper_defaults)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --disable-appfirewall
if [ "$DISABLE_APPFIREWALL" = true ]; then
    core_debug_print "Executing functions for --disable-appfirewall"
    result=$(execute_function disable_appfirewall_socketfilter)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --enable-appfirewall
if [ "$ENABLE_APPFIREWALL" = true ]; then
    core_debug_print "Executing functions for --enable-appfirewall"
    result=$(execute_function enable_appfirewall_socketfilter)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --disable-alf
if [ "$DISABLE_ALF" = true ]; then
    core_debug_print "Executing functions for --disable-alf"
    result=$(execute_function disable_appfirewall_defaults)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --enable-alf
if [ "$ENABLE_ALF" = true ]; then
    core_debug_print "Executing functions for --enable-alf"
    result=$(execute_function enable_appfirewall_defaults)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --disable-spctl
if [ "$DISABLE_SPCTL" = true ]; then
    core_debug_print "Executing functions for --disable-spctl"
    result=$(execute_function disable_gatekeeper_spctl)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --enable-spctl
if [ "$ENABLE_SPCTL" = true ]; then
    core_debug_print "Executing functions for --enable-spctl"
    result=$(execute_function enable_gatekeeper_spctl)
    raw_output="${raw_output}${result}"
fi

# Execute functions for --check-status
if [ "$CHECK_STATUS" = true ]; then
    core_debug_print "Executing functions for --check-status"
    result=$(execute_function check_status)
    raw_output="${raw_output}${result}"
fi
...
procedure="modify_firewall_settings"
...
# Function: disable_gatekeeper_defaults
# Description: disable_gatekeeper_defaults - Generated from YAML
...
# Function: enable_gatekeeper_defaults
# Description: enable_gatekeeper_defaults - Generated from YAML
...
# Function: disable_appfirewall_socketfilter
# Description: disable_appfirewall_socketfilter - Generated from YAML
...
# Function: enable_appfirewall_socketfilter
# Description: enable_appfirewall_socketfilter - Generated from YAML
...
# Function: disable_appfirewall_defaults
# Description: disable_appfirewall_defaults - Generated from YAML
...
# Function: enable_appfirewall_defaults
# Description: enable_appfirewall_defaults - Generated from YAML
...
# Function: disable_gatekeeper_spctl
# Description: disable_gatekeeper_spctl - Generated from YAML
...
# Function: enable_gatekeeper_spctl
# Description: enable_gatekeeper_spctl - Generated from YAML
...
# Description: check_status - Generated from YAML
check_status() {
...
# Description: restore_security_defaults - Generated from YAML
