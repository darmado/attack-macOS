...
SCRIPT:
  --safari                         Extract Safari history
  --chrome                         Extract Chrome history
  --firefox                        Extract Firefox history
  --brave                          Extract Brave history
...
# Execute functions for --brave
if [ "$BRAVE" = true ]; then
    core_debug_print "Executing functions for --brave"
