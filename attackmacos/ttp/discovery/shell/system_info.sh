...
SCRIPT:
  --help ENABLE|DISABLE            Display help message with detailed command information
...
if [ "$ALL" = true ]; then
    ...
    result=$(execute_function check_basic_system_info)
    raw_output="${raw_output}${result}"
    result=$(execute_function check_hardware_info)
    raw_output="${raw_output}${result}"
    result=$(execute_function check_environment_info)
    raw_output="${raw_output}${result}"
    result=$(execute_function check_network_config)
    raw_output="${raw_output}${result}"
    result=$(execute_function check_boot_security)
    raw_output="${raw_output}${result}"
    result=$(execute_function check_power_info)
    raw_output="${raw_output}${result}"
fi
