...
EDR_PATTERN="(sentinel|crowdstrike|carbonblack|cylance|endgame|cortex|defender|bitdefender|sophos|kaspersky|trend|symantec|mcafee|norton|avast|avg|malwarebytes|eset|f-secure|panda|webroot|avira|gdata|emsisoft)"
AV_PATTERN="(antivirus|anti-virus|defender|bitdefender|sophos|kaspersky|trend|symantec|mcafee|norton|avast|avg|malwarebytes|eset|f-secure|panda|webroot|avira|gdata|emsisoft)"
OST_PATTERN="(lulu|blockblock|knockknock|reikey|whatsyoursign|processmonitor|filesetup|netiquette|oversight|dnsmonitor|taskexplorer)"
MRT_PATTERN="(mrt|malware.removal|xprotect|yara|clamav|maldet)"
LOGFORWARD_PATTERN="(splunk|elastic|logstash|fluentd|rsyslog|syslog|graylog|sumo|datadog|newrelic)"
VPN_PATTERN="(vpn|openvpn|wireguard|tunnelblick|viscosity|nordvpn|expressvpn|surfshark|cyberghost|purevpn)"
HIDS_PATTERN="(hids|ossec|samhain|aide|tripwire|rkhunter|chkrootkit|tiger|lynis)"
