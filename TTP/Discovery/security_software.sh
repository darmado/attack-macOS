...
# Lists application files in the specified directory
...
#FunctionType: attackScript
# Retrieves system profiler information for applications
# T1518.001 - Security Software Discovery
...
#FunctionType: attackScript
# Lists running processes matching a specific pattern
# T1518.001 - Security Software Discovery
cmd_ps() {
    eval "$CMD_PS '$1'" 2>&1
}
